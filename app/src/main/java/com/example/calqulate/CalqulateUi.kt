...
import com.example.calqulate.ui.theme.Orange

@Composable
fun CalqulateUi(
    state: CalqulateState,
    modifier: Modifier = Modifier,
    buttonSpacing: Dp = 8.dp,
    onAction: (CalqulateAction) -> Unit,
) {
            ...
            Row(
                ...
                CalqulateButton(
                    ...
                    modifier = Modifier
                        ...
                        .weight(2f),
                    onClick = {
                        onAction(CalqulateAction.Clear)
                    }
                )
                CalqulateButton(
                    symbol = "Del",
                    modifier = Modifier
                        ...
                        .weight(1f),
                    onClick = {
                        onAction(CalqulateAction.Delete)
                    }
                )
                CalqulateButton(
                    symbol = "/",
                    modifier = Modifier
                        ...
                        .weight(1f),
                    onClick = {
                        onAction(CalqulateAction.Operation(CalqulateOperation.Divide))
                    }
                )
            }
            Row(
